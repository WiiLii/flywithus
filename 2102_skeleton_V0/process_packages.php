...
//             <div class="info-day">7+ Days</div>
//           </header>';
//             $mytable.='<p>'.$row['itineraryOverview'].'</p>';
//           $mytable.='<div class="reviews-holder">
//             <div class="star-rating">
//               <span><span class="icon-star"></span></span>
//               <span><span class="icon-star"></span></span>
//               <span><span class="icon-star"></span></span>
...
//         </div>
//         <aside class="info-aside">';
//           $mytable.='<span class="price">from <span>'.$row['totalPrice'].'</span></span>
//           <div class="activity-level">
//             <div class="ico">
//               <span class="icon-level2"></span>
//             </div>
//             <span class="text">'.$row['itineraryCountry'].'</span>
//           </div>
