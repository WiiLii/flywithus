						...
						<nav class="nav-wrap" id="sticky-tab">
							<div class="container">
								...
								<ul class="nav nav-tabs text-center" role="tablist">
									<li role="presentation" class="active"><a href="#tab01" aria-controls="tab01" role="tab" data-toggle="tab">Korea</a></li>
									<li role="presentation"><a href="#tab02" aria-controls="tab02" role="tab" data-toggle="tab">China</a></li>
									<li role="presentation"><a href="#tab03" aria-controls="tab03" role="tab" data-toggle="tab">Thailand</a></li>
									<li role="presentation"><a href="#tab04" aria-controls="tab04" role="tab" data-toggle="tab">Japan</a></li>
								</ul>
							</div>
						</nav>
						</br>
