...
<html>
    ...
    <body>
        ...
        // }
        //check if the user has already submitted in the same year, to avoid going to SurveyResults,
        //pressing back, and then submitting again, creating more than one row   in a year.
        if (checkSurveyDone()) {
