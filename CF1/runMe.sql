...
(1, 'Travel', '#008000', 'no', 'no'),
(2, 'Accommodation', '#6495ED', 'no', 'no'),
(3, 'Eat', '#D2691E', 'no', 'no'),
(4, 'Misc.', '#fcde0f', 'no', 'no'),
(5, 'Common', '#D10052', 'no', 'yes');
...
(22, 'How many people are going with you?', 5, 'd', ''),
...
--
ALTER TABLE `answertbl`
  MODIFY `answerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
